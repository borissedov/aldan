namespace Aldan.Web.Framework.Models
{
    ...
    /// </summary>
    public abstract partial class BaseSearchModel : BaseAldanModel, IPagingRequestModel
    {
        #region Constants

        private const int DefaultGridPageSize = 15;
        private const int PopupGridPageSize = 7;
        private const string GridPageSizes = "7, 15, 20, 50, 100";
        ...
        {
            SetGridPageSize(DefaultGridPageSize, GridPageSizes);
        }
        ...
        {
            SetGridPageSize(PopupGridPageSize, GridPageSizes);
        }
