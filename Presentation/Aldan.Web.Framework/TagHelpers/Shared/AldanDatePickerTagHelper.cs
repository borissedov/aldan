...
{
    /// <summary>
    /// aldan-date-picker tag helper
    /// </summary>
    [HtmlTargetElement("aldan-date-picker", 
        Attributes = DayNameAttributeName + "," + MonthNameAttributeName + "," + YearNameAttributeName, 
        TagStructure = TagStructure.WithoutEndTag)]
    public class AldanDatePickerTagHelper : TagHelper
    {
        ...
        public AldanDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
