...
using Aldan.Web.Framework.Extensions;
...
{
    /// <summary>
    /// aldan-tabs tag helper
    /// </summary>
    [HtmlTargetElement("aldan-tabs", Attributes = IdAttributeName)]
    public class AldanTabsTagHelper : TagHelper
    {
        ...
        public AldanTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<AldanTabContextItem>();
            context.Items.Add(typeof(AldanTabsTagHelper), tabContext);
    ...
    /// <summary>
    /// "aldan-tab tag helper
    /// </summary>
    [HtmlTargetElement("aldan-tab", ParentTag = "aldan-tabs", Attributes = NameAttributeName)]
    public class AldanTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public AldanTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<AldanTabContextItem>)context.Items[typeof(AldanTabsTagHelper)];
            tabContext.Add(new AldanTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class AldanTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
