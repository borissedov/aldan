...
{
    /// <summary>
    /// aldan-action-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("aldan-action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AldanActionConfirmationTagHelper : TagHelper
    {
        ...
        public AldanActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
