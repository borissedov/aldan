...
{
    /// <summary>
    /// aldan-delete-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("aldan-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AldanDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public AldanDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
