...
{
    /// <summary>
    /// aldan-textarea tag helper
    /// </summary>
    [HtmlTargetElement("aldan-textarea", Attributes = ForAttributeName)]
    public class AldanTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public AldanTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
