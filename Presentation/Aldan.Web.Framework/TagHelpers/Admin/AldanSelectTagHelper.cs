...
{
    /// <summary>
    /// aldan-select tag helper
    /// </summary>
    [HtmlTargetElement("aldan-select", TagStructure = TagStructure.WithoutEndTag)]
    public class AldanSelectTagHelper : TagHelper
    {
        ...
        public AldanSelectTagHelper(IHtmlHelper htmlHelper)
        {
