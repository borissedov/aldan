...
namespace Aldan.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("aldan-panel", Attributes = NAME_ATTRIBUTE_NAME)]
    public class AldanPanelTagHelper : TagHelper
    {
        ...
        public AldanPanelTagHelper(IHtmlHelper htmlHelper)
        {
