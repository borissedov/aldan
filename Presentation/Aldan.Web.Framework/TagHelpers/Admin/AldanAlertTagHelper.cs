...
{
    /// <summary>
    /// aldan-alert tag helper
    /// </summary>
    [HtmlTargetElement("aldan-alert", Attributes = AlertNameId, TagStructure = TagStructure.WithoutEndTag)]
    public class AldanAlertTagHelper : TagHelper
    {
        ...
        public AldanAlertTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
