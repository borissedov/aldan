...
{
    /// <summary>
    /// aldan-editor tag helper
    /// </summary>
    [HtmlTargetElement("aldan-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AldanEditorTagHelper : TagHelper
    {
        ...
        public AldanEditorTagHelper(IHtmlHelper htmlHelper)
        {
