...
namespace Aldan.Web.Framework.Infrastructure.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAldanExceptionHandler(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAldanAuthentication(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseAldanMvc(this IApplicationBuilder application)
        {
