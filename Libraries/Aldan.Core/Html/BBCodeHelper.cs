...
using Aldan.Core.Html.CodeFormatter;

namespace Aldan.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the URL tags: [url=https://www.domain.com]my site[/url]
                // becomes: <a href="https://www.domain.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the URL tags: [url]https://www.domain.com[/url]
                // becomes: <a href="https://www.domain.com">https://www.domain.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.domain.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.domain.com/Content/Images/Image.jpg">
