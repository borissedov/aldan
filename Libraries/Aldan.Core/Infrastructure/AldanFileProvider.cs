...
namespace Aldan.Core.Infrastructure
{
    ...
    /// </summary>
    public class AldanFileProvider : PhysicalFileProvider, IAldanFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a AldanFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public AldanFileProvider(IHostingEnvironment hostingEnvironment)
