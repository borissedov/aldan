...
{
    /// <summary>
    /// Represents Aldan engine
    /// </summary>
    public class AldanEngine : IEngine
    {
        #region Properties
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new AldanException("Unknown dependency");
                        return service;
                    });
            ...
            throw new AldanException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
