...
using Aldan.Data.Mapping;
using Microsoft.EntityFrameworkCore;

namespace Aldan.Data
{
    /// <summary>
    /// Represents base object context
    /// </summary>
    public partial class AldanObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public AldanObjectContext(DbContextOptions<AldanObjectContext> options) : base(options)
        {
        }
