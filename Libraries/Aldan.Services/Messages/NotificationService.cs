...
namespace Aldan.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(AldanMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[AldanMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
            ...
            tempData[AldanMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
