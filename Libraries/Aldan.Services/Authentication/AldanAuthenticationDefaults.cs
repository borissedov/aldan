...
namespace Aldan.Services.Authentication
{
    ...
    /// </summary>
    public static partial class AldanAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string ClaimsIssuer => "aldanFramework";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey => "aldan.externalauth.errors";
    }
}